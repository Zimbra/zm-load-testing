...
CSV_PATH = f"{test_path}/one_to_one_chat_build_comparison/generic-one-to-one_chat-requests_standalone.csv"
...
def create_summary_html(users, duration):
    ...
    <body>
      <p>Hi Team,</p>
      <p>Please find below a summary of the latest performance test results for 1:1 Chat:</p>
...
def send_email_report(summary_html, table_html):
    msg = EmailMessage()
    msg['Subject'] = 'Automated Standalone 1:1 Chat Performance Test Report'
