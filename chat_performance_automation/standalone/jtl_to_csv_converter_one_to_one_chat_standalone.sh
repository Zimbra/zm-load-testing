...
rm -rf ${test_path}/one_to_one_chat_build_comparison/*
...
cp /tmp/Chat/results/generic-1-1-chat-requests.csv  ${test_path}/one_to_one_chat_build_comparison/generic-one-to-one_chat-requests_standalone.csv
