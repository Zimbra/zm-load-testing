...
rm -rf /tmp/Chat/advanced_chat/*.jtl
rm -rf /tmp/Chat/advanced_chat/advanced_chat_html_report/*
...
run_jmeter_test "${test_path}/tests/generic/Chat/Advanced_Chat_Solution.jmx" "${test_path}/tests/generic/Chat/load.prop" "/tmp/Chat/advanced_chat/generic-advanced-chat-requests.jtl" "/tmp/Chat/result/advanced_chat_html_report" "/tmp/Chat/result/generic-advanced-chat-requests.out"
...
echo "Advanced Chat load test execution has been completed !!"
