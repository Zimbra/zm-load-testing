...
build1_data = read_csv(f'{test_path}/advanced_chat_build_comparison/generic-advanced-chat-requests_baseline.csv')
build2_data = read_csv(f'{test_path}/advanced_chat_build_comparison/generic-advanced-chat-requests_benchmark.csv')
...
with open('/tmp/Chat/results/transaction_response_times_comparison_advanced_chat.csv', mode='w', newline='') as csvfile:
...
print("Comparison results have been saved for Advanced Chat load test")
