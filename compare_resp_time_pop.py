...
build1_data = read_csv(f'{test_path}/build_comparison/generic_pop_baseline.csv')
build2_data = read_csv(f'{test_path}/build_comparison/generic_pop_benchmark.csv')
...
with open('/tmp/results/transaction_response_times_comparison_pop.csv', mode='w', newline='') as csvfile:
...
print("Comparison results have been saved for POP")
