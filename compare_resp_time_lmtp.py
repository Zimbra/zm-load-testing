...
build1_data = read_csv(f'{test_path}/build_comparison/generic_lmtp_baseline.csv')
build2_data = read_csv(f'{test_path}/build_comparison/generic_lmtp_benchmark.csv')
...
with open('/tmp/results/transaction_response_times_comparison_lmtp.csv', mode='w', newline='') as csvfile:
...
print("Comparison results have been saved for LMTP")
