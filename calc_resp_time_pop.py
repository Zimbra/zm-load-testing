...
def compare_builds(build1_csv, build2_csv):
    ...
    output_csv = '/tmp/results/transaction_response_times_comparison_pop.csv'
...
build1_csv_file = '/home/opc/zm-load-testing/build_comparison/generic_pop_B1.csv'
build2_csv_file = '/home/opc/zm-load-testing/build_comparison/generic_pop_B2.csv'
